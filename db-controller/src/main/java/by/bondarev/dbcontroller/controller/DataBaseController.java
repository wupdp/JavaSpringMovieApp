...
public class DataBaseController {
    ...
    @Operation(
            ...
            description = "Позволяет найти любой фильм по названию, если такой существует, и, при необходимости, добавить его в БД"
    )
    @GetMapping("/info")
    ...
    @Operation(
            summary = "Поиск фильмов в БД (ONLY) по фильтру: страна",
            description = "Возвращает все найденные фильмы по фильтру"
    )
    ...
    @Operation(
            summary = "Возвращает все доступные фильмы в БД"
    )
    @GetMapping("/all")
    ...
    @Operation(
            summary = "Поиск фильмов в БД (ONLY) по фильтру: жанр",
            description = "Возвращает все найденные фильмы по фильтру"
    )
    @GetMapping("/byGenre")
    ...
    @Operation(
            summary = "Поиск фильмов в БД (ONLY) по фильтру: человек",
            description = "Возвращает все найденные фильмы по фильтру"
    )
    @GetMapping("/byPerson")
    ...
    @Operation(
            summary = "Поиск фильмов в БД (ONLY) по фильтру: название",
            description = "Возвращает все найденные фильмы по фильтру"
    )
    @GetMapping("/byTitle")
    ...
    @Operation(
            summary = "Поиск фильма в БД по идентификатору",
            description = "Возвращает фильм, соответсвующий заданному идентификатору в БД"
    )
    @GetMapping("/{id}")
